...
C     CLOSE ALL FILES
      ...
      subroutine rddt3d(tmax,dh,dt,npc,nd,arbc,nsrc,nst,nx,ny,nz,
     ...
     +           sxgro2,sygro2,szgro2,read_step,write_step,write_step2,
     +           sgsn,filen,pht1,
     +           ifault,checkpoint,isfcvlm,imd5,ivelocity,
     +           media,io_opt,iperf,idyna,nvar,iost,partdeg,neg_lambda)
...
C     SGSN OUTPUT FILE OF ALL OTHER 19 VARIABLES   (CHAR)   (RETURNED)
      ...
      integer :: filen,read_step, write_step, write_step2
      real :: mu_ss, mu_dd,dt,tmax
      character (len=filen) :: chkp,chkj,insrc,invel
      character (len=filen) :: sxgro,sygro,szgro,sxgro2,sygro2,szgro2, sgsn
      integer :: checkpoint,ifault,isfcvlm,imd5,ivelocity
      integer :: media,io_opt,iperf,idyna,neg_lambda,nvar,iost,partdeg
...
c     +           sxgro2,sygro2,szgro2,filen
     ...
     +                                  sxgro2,sygro2,szgro2,filen)
      ...
      subroutine wrpm3d(nxt,nyt,nzt,nt,dh,dt,npc,
