...
subroutine GRHydro_HLLEAM(CCTK_ARGUMENTS)
...
!!$ alp, and beta in the flux dir
          ...
          if (flux_direction == 1) then
            call num_x_fluxAM(cons_p(1),cons_p(2),cons_p(3),cons_p(4),cons_p(5),&
            ...
            call num_x_fluxAM(cons_p(1),cons_p(3),cons_p(4),cons_p(2),cons_p(5),&
            ...
            call num_x_fluxAM(cons_p(1),cons_p(4),cons_p(2),cons_p(3),cons_p(5),&
...
!!$        Eigenvalues and fluxes either side of the cell interface
          ...
          if (flux_direction == 1) then
            ...
            call num_x_fluxAM(cons_p(1),cons_p(2),cons_p(3),cons_p(4),cons_p(5),&
                 ...
                 vxtp,vytp,vztp,pressstarp,bxlowp,bylowp,bzlowp,ab0p,wp, &
                 avg_det,avg_alp,avg_beta)
            call num_x_fluxAM(cons_m(1),cons_m(2),cons_m(3),cons_m(4),cons_m(5),&
            ...
            call num_x_fluxAM(cons_p(1),cons_p(3),cons_p(4),cons_p(2),cons_p(5),&
                 ...
                 vytp,vztp,vxtp,pressstarp,bylowp,bzlowp,bxlowp,ab0p,wp, &
                 avg_det,avg_alp,avg_beta)
            call num_x_fluxAM(cons_m(1),cons_m(3),cons_m(4),cons_m(2),cons_m(5),&
            ...
            call num_x_fluxAM(cons_p(1),cons_p(4),cons_p(2),cons_p(3),cons_p(5),&
                 ...
                 vztp,vxtp,vytp,pressstarp,bzlowp,bxlowp,bylowp,ab0p,wp, &
                 avg_det,avg_alp,avg_beta)
            call num_x_fluxAM(cons_m(1),cons_m(4),cons_m(2),cons_m(3),cons_m(5),&
