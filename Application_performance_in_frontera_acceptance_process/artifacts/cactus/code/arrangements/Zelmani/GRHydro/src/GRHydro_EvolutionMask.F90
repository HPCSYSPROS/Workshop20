...
! wrapper routine to be called by C code
subroutine GRHydro_DeclareEvolutionMask(cctkGH, evolution_mask, &
                                        evolution_mask_valid)
  ...
  use cctk
#endif
  use GRHydro_EvolutionMask, only: DeclareEvolutionMask => GRHydro_DeclareEvolutionMask
  ...
  call DeclareEvolutionMask(cctkGH, evolution_mask, evolution_mask_valid)
end subroutine
