...
subroutine GRHydro_InitialAtmosphereReset(CCTK_ARGUMENTS)
  ...
  CCTK_INT :: metric_timelevels, timelevel_used
...
! end EOS Omni vars
  ...
  call CCTK_ActiveTimeLevels(metric_timelevels, cctkGH, "ADMBase::metric")
  if (metric_timelevels .ne. timelevels .and. metric_timelevels .ne. 1) then
    write (warnline, *) "Unexpected number of metric timelevels: ",&
                        metric_timelevels,".Only 1 or HydroBase::timelevels (",&
                        timelevels,") are supported"
  ...
  if (timelevels .gt. 1) then
    if (GRHydro_UseGeneralCoordinates(cctkGH).ne.0) then
      ! this handles both cases where only a single metric timelevel exists
      ! (eg Cowling) as well as the case where the metric is time dependent
      ! and needs three level
      timelevel_used = min(metric_timelevels-1, 1)
      call CCTK_VarDataPtr(pg11_p, cctkGH, timelevel_used, "GRHydro::gaa")
      call CCTK_VarDataPtr(pg12_p, cctkGH, timelevel_used, "GRHydro::gab")
      call CCTK_VarDataPtr(pg13_p, cctkGH, timelevel_used, "GRHydro::gac")
      call CCTK_VarDataPtr(pg22_p, cctkGH, timelevel_used, "GRHydro::gbb")
      call CCTK_VarDataPtr(pg23_p, cctkGH, timelevel_used, "GRHydro::gbc")
      call CCTK_VarDataPtr(pg33_p, cctkGH, timelevel_used, "GRHydro::gcc")
      pvup_p = loc(lvel_p)
    else
      timelevel_used = min(metric_timelevels-1, 1)
      call CCTK_VarDataPtr(pg11_p, cctkGH, timelevel_used, "ADMBase::gxx")
      call CCTK_VarDataPtr(pg12_p, cctkGH, timelevel_used, "ADMBase::gxy")
      call CCTK_VarDataPtr(pg13_p, cctkGH, timelevel_used, "ADMBase::gxz")
      call CCTK_VarDataPtr(pg22_p, cctkGH, timelevel_used, "ADMBase::gyy")
      call CCTK_VarDataPtr(pg23_p, cctkGH, timelevel_used, "ADMBase::gyz")
      call CCTK_VarDataPtr(pg33_p, cctkGH, timelevel_used, "ADMBase::gzz")
      pvup_p = loc(vel_p)
    end if
  end if 
  if (timelevels .gt. 2) then
    if (GRHydro_UseGeneralCoordinates(cctkGH).ne.0) then
      timelevel_used = min(metric_timelevels-1, 2)
      call CCTK_VarDataPtr(pg11_p_p, cctkGH, timelevel_used, "GRHydro::gaa")
      call CCTK_VarDataPtr(pg12_p_p, cctkGH, timelevel_used, "GRHydro::gab")
      call CCTK_VarDataPtr(pg13_p_p, cctkGH, timelevel_used, "GRHydro::gac")
      call CCTK_VarDataPtr(pg22_p_p, cctkGH, timelevel_used, "GRHydro::gbb")
      call CCTK_VarDataPtr(pg23_p_p, cctkGH, timelevel_used, "GRHydro::gbc")
      call CCTK_VarDataPtr(pg33_p_p, cctkGH, timelevel_used, "GRHydro::gcc")
      pvup_p_p = loc(lvel_p_p)
    else
      timelevel_used = min(metric_timelevels-1, 2)
      call CCTK_VarDataPtr(pg11_p_p, cctkGH, timelevel_used, "ADMBase::gxx")
      call CCTK_VarDataPtr(pg12_p_p, cctkGH, timelevel_used, "ADMBase::gxy")
      call CCTK_VarDataPtr(pg13_p_p, cctkGH, timelevel_used, "ADMBase::gxz")
      call CCTK_VarDataPtr(pg22_p_p, cctkGH, timelevel_used, "ADMBase::gyy")
      call CCTK_VarDataPtr(pg23_p_p, cctkGH, timelevel_used, "ADMBase::gyz")
      call CCTK_VarDataPtr(pg33_p_p, cctkGH, timelevel_used, "ADMBase::gzz")
