void nuc_eosK_C_linterp_some(double x, double y, double z,
...
//!---------------------------------------------------------------------
  ...
  // helper variables
  double fh[8][4], delx, dely, delz, a[8];  // temp fix for opencl restriction on variable length arrays
...
void nuc_eosK_C_linterp_one(double x, double y, double z,
			    double* f, __global double* ft, 
			    int* ivs,
...
//!---------------------------------------------------------------------
  ...
  // helper variables
  double fh[8][1], delx, dely, delz, a[8];  // temp fix for opencl restriction on variable length arrays
  double dx,dy,dz,dxi,dyi,dzi,dxyi,dxzi,dyzi,dxyzi;
  int ix,iy,iz;
