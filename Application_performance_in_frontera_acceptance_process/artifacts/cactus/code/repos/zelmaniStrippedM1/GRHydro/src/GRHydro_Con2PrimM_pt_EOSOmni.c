...
//       #pragma omp critical
//       CCTK_WARN(failinfomode,"EOS error in c2pm 3");
...
//       fprintf(stdout,"rho=%f, dens=%f, epsilon=%f, temp=%f, temp0=%f, ye=%f\n", rho0,dens,*epsilon,*temp_in,eosvars.eos_temp[0],eosvars.eos_y_e[0]);
//       fprintf(stdout,"code=%d\n",eosvars.eoskeyerr[0]);
//       CCTK_WARN(failinfomode,"Aborting!!!")
    }
  }
