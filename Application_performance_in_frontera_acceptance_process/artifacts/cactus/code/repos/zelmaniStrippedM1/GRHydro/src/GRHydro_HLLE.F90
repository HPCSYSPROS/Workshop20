...
subroutine GRHydro_HLLE(CCTK_ARGUMENTS)
  ...
  CCTK_REAL :: gxxh, gxyh, gxzh, gyyh, gyzh, gzzh, uxxh, uxyh, &
       uxzh, uyyh, uyzh, uzzh, avg_beta, usendh, susendh
  ...
  !$OMP                     usendh, susendh, charmin, charmax, charpm, &
  !$OMP                     m,etabar)
...
!!$        Find minimum and maximum wavespeeds
          ...
          ! Introduce some dissipation by decreasing/increasing min/max wavespeeds
