...
c
	...
	write (20000+taskid,902) istep,kstep,icall,(pp2(j,1),j=1,6)
	end if
c
	rtime1=MPI_WTIME()
...
c
	...
	write (20000+taskid,902) istep,kstep,icall,(pp2h(1,j),j=1,3)
	end if
c
...
c
	...
	indexp=6
  	call part_interp (indexp)
c
c	call time_stamp ('partsp: end 400')
c
 90	continue
