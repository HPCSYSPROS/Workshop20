...
c
      ...
      real(p8)  bsy(xiind,nby,zjind,nv)[0:*]
#else
      real(p8)  bsy(xiind,nby,zjind,nv)
#endif
...
#ifdef DEBUG
!$OMP BARRIER
	if(ithr.eq.0) call buf3_minmax ('after omp',buf3,nv)
!$OMP BARRIER
#endif
...
#ifdef DEBUG
!	do iv=1,nv
!	call bsminmax ('exit spxyz_m',bsy(1,1,1,iv),1)
!	call bsminmaxv ('exit spxyz_m',bsy(1,1,1,iv),1)
!	call bsv2 ('exit spxyz_m',bsy(1,1,1,iv),1)
!	end do
#endif
