...
c
	...
	real*8 sumd,termu,termv,termw,term,sum0
c
...
c
	...
	pp(:,indexp)=0.
      ...
      call spcal_local (nxyz, gsh(1,1), bs, pp(1,1), pp(1,indexp),
     1                  nump1, jj, 1., ndpart, iod(1,1), 2)
c
...
c
	...
	if(nop2.gt.0) then
      ...
      call spcal_local (nxyz, gsh(1,1), bs, pp2(1,1), pp2(1,indexp),
     1                  nump2, jj, 1., ndpart2, iod(1,1), 2)
...
c
	call MPI_REDUCE (sumd,sum0,1,MPI_REAL8,MPI_SUM,0,
